...
export const staffService = {
  ...
  sendStaffCredentials: (email: string, password?: string, inviteUrl?: string): Promise<void> =>
    apiClient.fetch(`${apiClient.authUrl}/staff/send-credentials`, {
      method: 'POST',
      body: JSON.stringify({ email, password, inviteUrl }),
      requireAuth: true,
    }),
};
