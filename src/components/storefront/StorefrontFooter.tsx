              ...
              <div className="p-4 rounded-xl bg-muted/50 border border-border/50">
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    className="flex-1 h-10 px-3 text-sm rounded-lg bg-background border border-border/50 focus:border-primary/50 focus:outline-none transition-colors"
                  />
                  <button className="h-10 w-10 rounded-lg gradient-primary text-white flex items-center justify-center hover:shadow-glow transition-shadow">
