...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  // Helper to sanitize color values to prevent XSS via CSS injection
  const safeColor = (color: string | undefined): string | null => {
    if (!color) return null;
    // Allow only safe characters for CSS colors (hex, rgb, hsl, names, etc.)
    // Deny sensitive characters like <, >, ", ', ;, etc. that could break out of style context
