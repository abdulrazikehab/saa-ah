        ...
        <div className="py-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              {progress.total > 0 ? (
                <span className="text-muted-foreground font-semibold" dir="ltr">
          ...
          {onCancel && !isComplete && (
            <div className="flex justify-end pt-2 border-t mt-4">
              <button 
                onClick={() => onCancel()}
                className="px-4 py-2 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-md transition-colors font-medium"
              >
                إلغاء العملية
              </button>
            </div>
