  ...
  const navigationSections: NavigationSection[] = [
    {
      title: 'الرئيسية',
      items: [
        { name: 'لوحة التحكم', href: '/buyer', icon: Home, badge: null },
        { name: 'تصفح المنتجات', href: '/products', icon: Store, badge: null },
      ],
    },
    {
      title: 'مشترياتي',
      items: [
        { name: 'منتجاتي الرقمية', href: '/buyer/products', icon: Package, badge: null },
        { name: 'طلباتي', href: '/buyer/orders', icon: ShoppingCart, badge: null },
        { name: 'المفضلة', href: '/buyer/favorites', icon: Heart, badge: null },
        { name: 'التحميلات', href: '/buyer/downloads', icon: Download, badge: null },
      ],
    },
    {
      title: 'المالية',
      items: [
        { name: 'المحفظة', href: '/buyer/wallet', icon: Wallet, badge: null },
        { name: 'المدفوعات', href: '/buyer/payments', icon: CreditCard, badge: null },
        { name: 'الفواتير', href: '/buyer/invoices', icon: FileText, badge: null },
      ],
    },
    {
      title: 'الدعم',
      items: [
        { name: 'تذاكر الدعم', href: '/buyer/support', icon: Headphones, badge: null },
        { name: 'الملف الشخصي', href: '/buyer/profile', icon: User, badge: null },
        { name: 'الإعدادات', href: '/buyer/settings', icon: Settings, badge: null },
      ],
    },
  ];
