...
import { SupportTicketsSection, FavoritesPageSection, BalanceOperationsSection, EmployeesPageSection, ChargeWalletSection, ReportsPageSection, ProfilePageSection, BankAccountsSection, CustomerOrdersSection } from './MerchantSections';
