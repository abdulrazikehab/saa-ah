...
export function getDefaultProps(type: string, t: TFunction): Record<string, unknown> {
  const defaults: Record<string, Record<string, unknown>> = {
    ...
    'contact-us': {
      title: t('builder.defaults.contactUs.title', 'تواصل معنا'),
      subtitle: t('builder.defaults.contactUs.subtitle', 'نحن هنا لمساعدتك دائماً'),
      email: '',
      phone: '',
      address: '',
    },
    'about-us': {
      title: t('builder.defaults.aboutUs.title', 'من نحن'),
      subtitle: t('builder.defaults.aboutUs.subtitle', 'قصتنا ورؤيتنا'),
      content: '',
      imageUrl: '',
    },
    'cart-section': {
      title: t('sections.cart.title', 'Shopping Cart'),
      showTotal: true,
      showItemCount: true,
    },
    'auth-section': {
      defaultMode: 'login',
      heroTitle: t('sections.auth.heroTitle', 'Welcome Back'),
      heroSubtitle: t('sections.auth.heroSubtitle', 'Log in to manage your account'),
    },
    'checkout-section': {
      title: t('sections.checkout.title', 'Checkout'),
      buttonText: t('sections.checkout.placeOrder', 'Place Order'),
    },
    'customer-orders': {
      title: t('sections.customerOrders.title', 'My Orders'),
      titleAr: 'طلباتي',
      showSearch: true,
      showFilters: true,
    ...
    'inventory-page': {
      title: t('sections.inventory.title', 'Inventory'),
      titleAr: 'المخزون',
      showSearch: true,
      showFilters: true,
    },
    'store-page': {
      title: t('sections.storePage.title', 'Store Settings'),
      showSearch: true,
      showFilters: true,
    },
    'permissions-page': {
      title: t('sections.permissions.title', 'Permissions Management'),
      titleAr: 'إدارة الصلاحيات',
      subtitle: t('sections.permissions.subtitle', 'Manage employee access and permissions'),
      subtitleAr: 'إدارة وصول الموظفين وصلاحياتهم',
    },
    'product-list': {
      title: t('sections.productList.title', 'Product List'),
      titleAr: 'قائمة المنتجات',
      subtitle: t('sections.productList.subtitle', 'Manage your inventory and products'),
      subtitleAr: 'إدارة المخزون والمنتجات الخاصة بك',
    },
    'merchant-dashboard': {
      title: t('sections.merchantDashboard.title', 'Merchant Dashboard'),
      titleAr: 'لوحة تحكم التاجر',
      subtitle: t('sections.merchantDashboard.subtitle', 'Track your store performance'),
      subtitleAr: 'تتبع أداء متجرك',
    },
    'support-tickets': {
      title: t('sections.supportTickets.title', 'Support Tickets'),
      titleAr: 'تذاكر الدعم',
    },
    'favorites-page': {
      title: t('sections.favorites.title', 'Favorites'),
      titleAr: 'المفضلة',
    },
    'balance-operations': {
      title: t('sections.balanceOperations.title', 'Balance Operations'),
      titleAr: 'عمليات الرصيد',
    },
    'employees-page': {
      title: t('sections.employees.title', 'Employees'),
      titleAr: 'الموظفين',
    },
    'charge-wallet': {
      title: t('sections.chargeWallet.title', 'Charge Wallet'),
      titleAr: 'شحن المحفظة',
    },
    'reports-page': {
      title: t('sections.reports.title', 'Reports'),
      titleAr: 'التقارير',
    },
    'profile-page': {
      title: t('sections.profile.title', 'Profile'),
      titleAr: 'الملف الشخصي',
    },
    'bank-accounts': {
      title: t('sections.bankAccounts.title', 'Bank Accounts'),
