...
import { X, Plus, Trash2, Type, Layout, Palette, Settings, AlignLeft, AlignCenter, AlignRight, Code, Loader2, Sparkles } from 'lucide-react';
...
export const PropertyPanel = ({ section, onUpdate, onClose }: PropertyPanelProps) => {
  ...
  const handleGenerateText = async (key: string, type: string, currentVal: string) => {
    setGeneratingText(key);
    try {
      const prompt = currentVal || `Write a ${type} for my website`;
      const result = await aiService.generateText(prompt, type);
      if (result.text) {
  ...
  const AITextButton = ({ fieldKey, fieldType, currentVal }: { fieldKey: string, fieldType: string, currentVal: string }) => (
    <Button
      variant="ghost"
      size="icon"
      className="h-6 w-6 text-purple-600 hover:text-purple-700 hover:bg-purple-50 shrink-0"
      onClick={() => handleGenerateText(fieldKey, fieldType, currentVal)}
      disabled={generatingText === fieldKey}
      title={t('properties.generateAI', 'Generate with AI')}
    >
      {generatingText === fieldKey ? (
    ...
    switch (type) {
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between">
                ...
                <AITextButton fieldKey="companyName" fieldType="company name" currentVal={props.companyName as string} />
              </div>
              <Input
            ...
            <div className="space-y-3 pt-2 border-t">
              ...
              <div className="flex items-center justify-between">
                <Label>{t('properties.showLogin', 'Show Login Button')}</Label>
                <Switch
                  checked={(props.showLogin as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showLogin', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
      ...
      case 'hero':
        return (
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.name', 'Name')} (English)</Label>
                <AITextButton fieldKey="name" fieldType="hero name" currentVal={props.name as string} />
              </div>
              <Input
            ...
            <div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.name', 'Name')} (العربية)</Label>
                <AITextButton fieldKey="nameAr" fieldType="hero name arabic" currentVal={props.nameAr as string} />
              </div>
              <Input
                value={(props.nameAr as string) || ''}
            ...
            <div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.description', 'Description')} (English)</Label>
                <AITextButton fieldKey="description" fieldType="hero description" currentVal={props.description as string} />
              </div>
              <Textarea
            ...
            <div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.description', 'Description')} (العربية)</Label>
                <AITextButton fieldKey="descriptionAr" fieldType="hero description arabic" currentVal={props.descriptionAr as string} />
              </div>
              <Textarea
                value={(props.descriptionAr as string) || ''}
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <AITextButton fieldKey="title" fieldType="hero title" currentVal={props.title as string} />
              </div>
              <Input
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <AITextButton fieldKey="subtitle" fieldType="hero subtitle" currentVal={props.subtitle as string} />
              </div>
              <Textarea
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between">
                ...
                <AITextButton fieldKey="title" fieldType="section title" currentVal={props.title as string} />
              </div>
              <Input
                value={(props.title as string) || ''}
                onChange={(e) => handleChange('title', e.target.value)}
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between">
                ...
                <AITextButton fieldKey="content" fieldType="long text content" currentVal={props.content as string} />
              </div>
              <Textarea
                rows={12}
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleChange('title', e.target.value)}
                className="mt-1.5"
                placeholder={t('cart.title', 'Shopping Cart')}
              />
            </div>
            <div>
              <Label>{t('properties.emptyMessage', 'Empty Cart Message')}</Label>
              <Input
                value={(props.emptyMessage as string) || ''}
                onChange={(e) => handleChange('emptyMessage', e.target.value)}
                className="mt-1.5"
                placeholder={t('cart.empty', 'Your cart is empty')}
              />
            </div>
            <div className="space-y-3 pt-2 border-t">
              <h4 className="font-medium text-sm">{t('properties.displayOptions', 'Display Options')}</h4>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showTotal', 'Show Total')}</Label>
                <Switch
                  checked={(props.showTotal as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showTotal', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showItemCount', 'Show Item Count')}</Label>
                <Switch
                  checked={(props.showItemCount as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showItemCount', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showQuantity', 'Show Quantity Controls')}</Label>
                <Switch
                  checked={(props.showQuantity as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showQuantity', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showCoupon', 'Show Coupon Field')}</Label>
                <Switch
                  checked={(props.showCoupon as boolean) !== false}
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleChange('title', e.target.value)}
                className="mt-1.5"
                placeholder={t('checkout.title', 'Checkout')}
              />
            </div>
            <div>
              <Label>{t('properties.buttonText', 'Button Text')}</Label>
              <Input
                ...
                onChange={(e) => handleChange('buttonText', e.target.value)}
                className="mt-1.5"
                placeholder={t('checkout.placeOrder', 'Place Order')}
              />
            </div>
            <div className="space-y-3 pt-2 border-t">
              <h4 className="font-medium text-sm">{t('properties.displayOptions', 'Display Options')}</h4>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showShipping', 'Show Shipping Form')}</Label>
                <Switch
                  checked={(props.showShipping as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showShipping', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showPayment', 'Show Payment Methods')}</Label>
                <Switch
                  checked={(props.showPayment as boolean) !== false}
                  onCheckedChange={(checked) => handleChange('showPayment', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <Label>{t('properties.showOrderSummary', 'Show Order Summary')}</Label>
                <Switch
                  checked={(props.showOrderSummary as boolean) !== false}
      ...
      case 'store-page':
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-3 pt-2 border-t">
              <div className="flex items-center justify-between">
                <Label>{t('properties.showSearch', 'Show Search')}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label>{t('properties.showFilters', 'Show Filters')}</Label>
                <Switch
                  checked={(props.showFilters as boolean) !== false}
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleChange('title', e.target.value)}
                className="mt-1.5"
                placeholder={t('properties.titlePlaceholder', 'Enter title')}
              />
            </div>
             <div>
              <Label>{t('properties.titleAr', 'Title (Arabic)')}</Label>
              <Input
                value={(props.titleAr as string) || ''}
                onChange={(e) => handleChange('titleAr', e.target.value)}
                className="mt-1.5"
                placeholder={t('properties.titleArPlaceholder', 'Enter Arabic title')}
              />
            </div>
            <div>
              <Label>{t('properties.subtitle', 'Subtitle')}</Label>
              <Input
                ...
                onChange={(e) => handleChange('subtitle', e.target.value)}
                className="mt-1.5"
                placeholder={t('properties.subtitlePlaceholder', 'Enter subtitle')}
              />
            </div>
             <div>
              <Label>{t('properties.subtitleAr', 'Subtitle (Arabic)')}</Label>
              <Input
                value={(props.subtitleAr as string) || ''}
                onChange={(e) => handleChange('subtitleAr', e.target.value)}
                className="mt-1.5"
                placeholder={t('properties.subtitleArPlaceholder', 'Enter Arabic subtitle')}
              />
            </div>
            ...
            <div className="space-y-3 pt-2 border-t">
                 <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <Label>{t('properties.showStatusBadge', 'Show Status Badge')}</Label>
                    <Switch
                      checked={(props.showStatusBadge as boolean) !== false}
                      onCheckedChange={(checked) => handleChange('showStatusBadge', checked)}
                    />
                  </div>
            </div>
          </div>
      ...
      case 'categories-hierarchy':
        return (
           <div className="space-y-4">
            ...
            <div>
                <Label>{t('properties.productsPerCategory', 'Products Per Category')}</Label>
                <Input
                  type="number" 
                  value={(props.productsPerCategory as number) || 8}
                  onChange={(e) => handleChange('productsPerCategory', parseInt(e.target.value))}
                  className="mt-1.5"
                />
            </div>
           </div>
      ...
      case 'testimonials':
         return (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded text-sm text-gray-500 text-center">
                  {t('properties.complexSection', 'This section has complex properties. Please use the Code Editor to modify items fully.')}
                  <Button variant="outline" size="sm" className="mt-2 w-full" onClick={() => setShowCodeEditor(true)}>
                      <Code className="w-4 h-4 mr-2" />
                      {t('properties.openCodeEditor', 'Open Code Editor')}
                  </Button>
              </div>
            </div>
         );
      ...
      case 'auth-section':
        return (
          <div className="space-y-4">
             <div>
              <Label>{t('properties.defaultMode', 'Default Mode')}</Label>
              <Select
                value={(props.defaultMode as string) || 'login'}
                onValueChange={(value) => handleChange('defaultMode', value)}
              >
                <SelectTrigger className="mt-1.5">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="login">{t('auth.login.title', 'Login')}</SelectItem>
                  <SelectItem value="signup">{t('auth.signup.title', 'Sign Up')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            
            <div className="flex items-center justify-between pt-2 border-t">
               <Label>{t('properties.showHero', 'Show Hero Section')}</Label>
               <Switch
                 checked={(props.showHero as boolean) !== false}
                 onCheckedChange={(checked) => handleChange('showHero', checked)}
               />
            </div>

            {(props.showHero as boolean) !== false && (
              <>
                <div className="pt-2 border-t">
                  <Label>{t('properties.heroTitle', 'Hero Title')} (English)</Label>
                  <Input
                    value={(props.heroTitle as string) || ''}
                    onChange={(e) => handleChange('heroTitle', e.target.value)}
                    className="mt-1.5"
                  />
                </div>
                <div>
                  <Label>{t('properties.heroTitleAr', 'Hero Title')} (العربية)</Label>
                  <Input
                    value={(props.heroTitleAr as string) || ''}
                    onChange={(e) => handleChange('heroTitleAr', e.target.value)}
                    className="mt-1.5"
                  />
                </div>
                <div>
                  <Label>{t('properties.heroSubtitle', 'Hero Subtitle')} (English)</Label>
                  <Textarea
                    value={(props.heroSubtitle as string) || ''}
                    onChange={(e) => handleChange('heroSubtitle', e.target.value)}
                    className="mt-1.5"
                  />
                </div>
                <div>
                  <Label>{t('properties.heroSubtitleAr', 'Hero Subtitle')} (العربية)</Label>
                  <Textarea
                    value={(props.heroSubtitleAr as string) || ''}
