          ...
          <div className="flex items-center justify-between h-20">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              >
                ...
                >
                  <img src={getLogoUrl()} alt="Koun" className="h-8 w-auto" />
                </motion.div>
              </motion.div>
              <div className="flex flex-col">
                <span className="text-xl font-bold tracking-tight">Ka wn</span>
                <span className="text-xs text-muted-foreground">كون</span>
              </div>
            </Link>
