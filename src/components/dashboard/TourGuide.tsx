              ...
              <CardContent className="p-6 relative z-10">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <motion.div
                    ...
                    className={cn(
                      "p-4 rounded-2xl flex-shrink-0 shadow-xl relative overflow-hidden",
                      isCenter 
                        ? "bg-gradient-to-br from-teal-500 via-cyan-500 to-teal-500"
                        : "bg-gradient-to-br from-teal-500/20 to-cyan-500/20 border-2 border-teal-500/30"
                    )}
                  >
                    {/* Icon glow effect */}
                    {isCenter && (
                    ...
                    <motion.div
                      ...
                      className={cn("relative z-10", isCenter ? "text-white" : "text-teal-500")}
                    >
                      {step.icon}
                    </motion.div>
                  </motion.div>
