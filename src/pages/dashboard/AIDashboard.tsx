        ...
        >
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-bold">سعة AI</h2>
                <p className="text-xs text-gray-400">Saeaa AI</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-auto pt-6 border-t border-gray-800/50">
            <div className="bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg p-4 border border-primary/30">
              <p className="text-xs text-gray-400 mb-2">{isRTL ? 'سعة GPT' : 'Saeaa GPT'}</p>
              <Button
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 mb-8 flex-wrap">
                {[
                  ...
                  { id: 'gpt', label: 'سعة GPT', labelEn: 'Saeaa GPT' },
                ].map((tab) => (
                  <button
                    key={tab.id}
                    onClick={() => {
