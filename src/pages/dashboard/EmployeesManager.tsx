...
const AVAILABLE_PERMISSIONS = [
  { id: 'manage_products', labelKey: 'employeesPage.permissions.manageProducts' },
  { id: 'manage_orders', labelKey: 'employeesPage.permissions.manageOrders' },
  { id: 'manage_customers', labelKey: 'employeesPage.permissions.manageCustomers' },
  { id: 'manage_settings', labelKey: 'employeesPage.permissions.manageSettings' },
