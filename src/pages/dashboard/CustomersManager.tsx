...
export default function CustomersManager() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('i18n:languageChanged', handleCustomLanguageChange);
    
    return () => {
      i18n.off('languageChanged', handleLanguageChange);
      window.removeEventListener('languagechange', handleCustomLanguageChange);
      window.removeEventListener('i18n:languageChanged', handleCustomLanguageChange);
    };
  }, [i18n]);
  
  // Debug: Log current language and translation
  useEffect(() => {
    console.log('🌐 CustomersManager - Language:', i18n.language);
    console.log('🌐 CustomersManager - Title translation:', t('dashboard.customers.title'));
    console.log('🌐 CustomersManager - isRTL:', isRTL);
