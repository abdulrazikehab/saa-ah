          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold">{balance.toFixed(2)} {t('currencies.SAR', 'SAR')}</p>
              </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="amount">{t('sections.chargeWallet.amount', 'Amount')} ({t('currencies.SAR', 'SAR')})</Label>
                <Input
                  id="amount"
                  type="number"
                  min="1"
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {quickAmounts.map((quickAmount) => (
                    ...
                    >
                      {quickAmount} {t('currencies.SAR', 'SAR')}
                    </Button>
                  ))}
                </div>
              </div>
