...
import { Transaction as BaseTransaction } from '@/services/transaction.service';
...
export default function TransactionManager({ adminApiKey }: TransactionManagerProps) {
  ...
  }, [effectiveApiKey, page, statusFilter, toast]);
