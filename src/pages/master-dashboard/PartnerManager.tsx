...
export default function PartnerManager({ adminApiKey }: { adminApiKey?: string }) {
  ...
  const loadPartners = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const response = await coreApi.get('/admin/master/partners', { 
        requireAuth: true, 
  ...
  const handleCreate = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await coreApi.post('/admin/master/partners', formData, { 
        requireAuth: true, 
        adminApiKey: adminApiKey 
      });
      toast({
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await coreApi.put(`/admin/master/partners/${encodedId}`, formData, { 
        requireAuth: true, 
        adminApiKey: adminApiKey 
      });
      toast({
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      await coreApi.delete(`/admin/master/partners/${encodedId}`, { 
        requireAuth: true, 
        adminApiKey: adminApiKey 
      });
      toast({
