...
export default function AiSettingsManager({ adminApiKey }: { adminApiKey?: string }) {
  ...
  const loadScript = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const response = await coreApi.get('/admin/master/ai-script', { 
        requireAuth: true, 
  ...
  const handleSave = async () => {
    ...
    try {
      setSaving(true);
      await coreApi.post('/admin/master/ai-script', { script }, { 
        requireAuth: true, 
        adminApiKey: adminApiKey 
      });
      toast({
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              ...
              Use this to define the AI's persona, general knowledge about Koun, and core policies.
            </p>
          </div>
        </div>
