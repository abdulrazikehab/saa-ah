...
export default function ComplaintsManager() {
  ...
  const loadComplaints = useCallback(async () => {
    try {
      ...
      const response = await coreApi.get('/admin/master/complaints', { 
        params,
        requireAuth: true, 
  ...
  const handleUpdatePriority = async (id: string, priority: string) => {
    try {
      ...
      loadComplaints();
      if (selectedComplaint?.id === id) {
        setSelectedComplaint({ ...selectedComplaint, priority: priority as any });
      }
    } catch (error) {
      toast({
        variant: 'destructive',
        ...
        <div className="p-4 border-b border-slate-800 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-950 border border-slate-800 rounded-lg text-sm text-white focus:outline-none focus:border-purple-500"
            />
          </div>
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <section>
                  <h4 className="text-sm font-medium text-gray-400 mb-3">Set Priority</h4>
                  <div className="flex flex-wrap gap-2">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <textarea
                    ...
                    placeholder="Type AI response or internal notes here..."
