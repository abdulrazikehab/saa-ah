          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                {isRTL 
                  ? 'نحن منصة "سعة"، شريكك الاستراتيجي في رحلة التجارة الإلكترونية. نقدم حلولاً متكاملة تساعدك على النمو والازدهار في السوق الرقمي.'
                  : 'We are "Saeaa", your strategic partner in the e-commerce journey. We provide integrated solutions that help you grow and thrive in the digital market.'}
              </p>
            </motion.div>
          </div>
